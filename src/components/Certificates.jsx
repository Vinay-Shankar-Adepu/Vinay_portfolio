      ...
      <div className="max-w-6xl mx-auto relative z-20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 mb-12">
          ...
          {certificates.featured.length === 0 && (
            <div className="sm:col-span-2 lg:col-span-3 rounded-2xl border border-white/15 bg-black/20 p-8 text-center" data-aos="zoom-in">
              <h3 className="text-xl font-black text-white mb-2">Certificates available on request</h3>
              <p className="text-white/65">A certificates document was not included in the supplied project assets.</p>
            </div>
          )}
        </div>

        {/* View All Certificates CTA */}
        {certificates.viewAllUrl && <div data-aos="fade-up" data-aos-delay="700" className="flex justify-center">
          <a
