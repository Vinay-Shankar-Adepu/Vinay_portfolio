...
export const projects = [
  { id: "canteen", number: "01", badge: "Featured Demo", title: "College Canteen Ordering App", description: "A Flutter ordering experience with Provider state management, Hive cart persistence, Razorpay payment flows, QR pickup, and a real-time administrator dashboard.", techTags: ["Flutter", "Dart", "Firestore", "Razorpay", "Hive", "Provider"], links: { github: "https://github.com/Vinay-Shankar-Adepu/KMIT_Canteen_App", certificate: "https://psapi.kmitonline.com/studentps/certificate/3b35953b-60c2-487a-bb2f-d5de2326d971", youtube: "https://www.youtube-nocookie.com/embed/GvpodO7-AQc?rel=0" }, isFlagship: true },
  ...
  { id: "fixitnow", number: "03", badge: "Team Lead · Live", title: "FixItNow", description: "A service-booking platform with 20+ listings. Led a five-member team, designed the architecture, built REST APIs, and implemented Firebase role-based access for customers, providers, and administrators.", techTags: ["React.js", "Node.js", "Express.js", "MongoDB", "Firebase"], links: { github: "https://github.com/Vinay-Shankar-Adepu/Local-Hands-01", demo: "https://localhands-45.vercel.app/" }, isFlagship: false },
