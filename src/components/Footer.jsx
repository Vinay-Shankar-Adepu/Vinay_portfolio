...
const Footer = () => {
  return (
    <footer className="bg-[#d9ff43] text-[#070a0f] py-16 px-6 md:px-12 w-full font-mono text-[10px] md:text-xs tracking-widest flex flex-col justify-between min-h-[50vh]">
      ...
      <div className="w-full flex justify-center items-center py-20 md:py-24 overflow-hidden">
        <h2 className="text-[18vw] md:text-[15vw] leading-none font-sans font-bold tracking-[-0.08em] lowercase select-none text-[#070a0f] w-full text-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8 w-full items-end font-medium">
        <div className="flex flex-col gap-6">
          ...
          <p className="text-[#070a0f]/55 font-mono text-[9px] md:text-[10px]">
        ...
        <div className="flex flex-col gap-3 md:items-center">
          ...
          <div className="flex items-center gap-4 mt-2">
            ...
            <a 
              ...
              className="text-[#070a0f] hover:text-[#536dfe] transition-colors duration-300"
              aria-label="GitHub"
            >
